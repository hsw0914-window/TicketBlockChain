...
const tierMeta: Record<TierName, {
  ...
  베이직: { entry: 0, earnRate: "0.5%", monthlyRaffle: 0, firstReward: "없음", color: "#6b7280", bg: "#e5e7eb" },
  브론즈: { entry: 3, earnRate: "0.7%", monthlyRaffle: 0, firstReward: "실물 NFT 1개", color: "#b45309", bg: "#ffedd5" },
  실버: { entry: 6, earnRate: "1.0%", monthlyRaffle: 1, firstReward: "실물 NFT 2개 + 우선 응모권 1장", color: "#64748b", bg: "#e2e8f0" },
  골드: { entry: 10, earnRate: "1.5%", monthlyRaffle: 2, firstReward: "실물 NFT 3개 + 우선 응모권 2장", color: "#d97706", bg: "#fef3c7" },
};
